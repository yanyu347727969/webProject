  ...
  <body>
	...
	<div class="container">
	    <div class="container col-sm-9">
	        <form action="/goodsAuction/admin/addItemStateAction" class="form-horizontal" role="form"  method="post" id="form">
	            <legend class="h1">发布物品状态</legend>
	            <div class="form-group">
	                <div class="col-sm-6">
	                    <input name="state_name" id="state_name" type="text" class="form-control" placeholder="状态名称">
	                </div>
	            </div>
	            <div class="form-group">
	                <div class="col-sm-3">
