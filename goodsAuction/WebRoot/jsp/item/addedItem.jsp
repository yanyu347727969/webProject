...
<div class="container">
    <div class="container col-sm-9">
        <form action="/goodsAuction/p/addedItemAction" class="form-horizontal" role="form"  method="post" id="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input  name="init_price" id="init_price" type="number" min="0.1" step="0.1" value="1" class="form-control">
                </div>
            </div>
            <div class="form-group">
