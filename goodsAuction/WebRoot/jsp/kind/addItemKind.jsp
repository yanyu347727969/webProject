...
<body>
	...
	<div class="container">
		<div class="container col-sm-9">
			<form action="/goodsAuction/admin/addItemKindAction"
				class="form-horizontal" role="form" method="post" id="form">
				<legend class="h1">发布物品种类</legend>
				<div class="form-group">
					<div class="col-sm-6">
						<input name="kind_name" id="kind_name" type="text"
							class="form-control" placeholder="种类名称">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-6">
						<input name="kind_desc" id="kind_desc" type="text"
							class="form-control" placeholder="种类描述">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-3">
