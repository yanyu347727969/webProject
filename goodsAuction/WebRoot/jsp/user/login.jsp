  ...
  <body>
	...
	<div class="container">
	    <div class="container col-sm-9">
	        <form action="/goodsAuction/d/loginAction" class="form-horizontal" role="form"  method="post" id="form">
	            <legend class="h1">登录</legend>
	            ...
	            <div class="form-group">
	                <div class="col-sm-6" style="text-align: right">
	                    <a href="/goodsAuction/jsp/user/register.jsp">免费注册</a>
	                </div>
	            </div>
