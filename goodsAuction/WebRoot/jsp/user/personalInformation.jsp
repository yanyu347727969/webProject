...
<body>
	<div class="container col-sm-9" style="margin-left: 50px">
		<form class="form-horizontal" role="form" id="form">
			...
			<div class="form-group">
				<div class="col-sm-6">
					<input value="${user.username}" id="username" type="text"
						class="form-control" disabled="disabled" placeholder="用户名">
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-6">
			...
			<span id="span_modifyPassowrd"> </span>
			<div class="form-group">
				<div class="col-sm-6">
					<input name="mobile" value="${user.mobile}" id="mobile" type="tel"
